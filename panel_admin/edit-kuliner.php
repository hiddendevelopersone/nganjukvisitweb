...
$id = $_GET["id_kuliner"];
$sqlquery = "SELECT * FROM informasi_kuliner where id_kuliner = '$id'";
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <input type="text" class="form-control" id="nama_kuliner" name="nama_kuliner" value="<?= $rows[0]["nama_kuliner"];?>">
        </div>
        <div class="mb-3">
