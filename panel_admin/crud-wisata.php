                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control-plaintext" id="nama_wisata"
                                            value="<php echo $nama_wisata?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control-plaintext" id="harga_tiket"
                                            value="<php echo $harga_tiket?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control-plaintext" id="jadwal"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control-plaintext" id="alamat"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control-plaintext" id="coordinate"
                                            value="<php echo $coordinate?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="linkmaps" class="col-sm-2 col-form-label">Linkmaps</label>
                                    <div class="col-sm-10">
                                        <input type="text" readonly class="form-control-plaintext" id="nama_wisata"
                                            value="<php echo $nama_wisata?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control-plaintext" id="deskripsi"
