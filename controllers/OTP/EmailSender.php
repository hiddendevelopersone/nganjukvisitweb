...
class EmailSender {
    ...
    private $smtpUsername = 'hiddendevelopersone@gmail.com';
    // private $smtpPassword = 'hftf uheb ztey nokf';
    private $smtpPassword = 'bfho xrmp auyp tjhv';
    private $smtpPort = 587;
    private $fromEmail = 'hiddendevelopersone@gmail.com';
    private $fromName = 'nganjukvisit';
