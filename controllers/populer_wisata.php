...
$sqlquery = "SELECT informasi_wisata.id_wisata, informasi_wisata.nama_wisata, informasi_wisata.deskripsi AS deskripsi, informasi_wisata.alamat, informasi_wisata.gambar, COUNT(favorit.id_user) AS jumlah_favorit
FROM `favorit`
