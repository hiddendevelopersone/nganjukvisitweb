...
$sqlquery = "SELECT informasi_penginapan.id_penginapan, informasi_penginapan.nama_penginapan, informasi_penginapan.deskripsi AS deskripsi, informasi_penginapan.lokasi, COUNT(favorit_penginapan.id_user) AS jumlah_favorit FROM `favorit_penginapan`
